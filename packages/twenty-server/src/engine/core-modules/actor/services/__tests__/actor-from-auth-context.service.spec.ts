...
describe('ActorFromAuthContextService', () => {
    ...
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        ...
        },
        {
          ...
          useValue: {
            findActiveByApiKeyId: jest.fn().mockResolvedValue(null),
          },
        },
      ],
    }).compile();
  ...
  describe('injectCreatedBy', () => {
    ...
    it('should build metadata from connected agent when the apiKey belongs to one', async () => {
      ...
      expect(connectedAgentService.findActiveByApiKeyId).toHaveBeenCalledWith(
        '20202020-56c2-471b-925d-31ed3ecd0951',
        '20202020-bdec-497f-847a-1bb334fefe58',
      );
      expect(result).toEqual<ExpectedResult>([
        {
          createdBy: {
