...
import { AddConnectedAgentFastInstanceCommand } from 'src/database/commands/upgrade-version-command/2-42/2-42-instance-command-fast-1789583518332-add-connected-agent';
import { AddAgentActivityFastInstanceCommand } from 'src/database/commands/upgrade-version-command/2-42/2-42-instance-command-fast-1789583518333-add-agent-activity';
...
export const INSTANCE_COMMANDS = [
  ...
  AddConnectedAgentFastInstanceCommand,
  AddAgentActivityFastInstanceCommand,
];
